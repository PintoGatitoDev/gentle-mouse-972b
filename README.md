...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/gentle-mouse-972b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-mouse-972b
```

A live public deployment of this template is available at [https://gentle-mouse-972b.templates.workers.dev](https://gentle-mouse-972b.templates.workers.dev)
